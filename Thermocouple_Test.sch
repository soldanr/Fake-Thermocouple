...
<pin name="4IN+" x="-17.78" y="-10.16" length="middle" direction="in"/>
<pin name="4IN-" x="-17.78" y="-12.7" length="middle" direction="in"/>
<pin name="GND" x="-17.78" y="-17.78" length="middle" direction="pas"/>
<pin name="1OUT" x="17.78" y="10.16" length="middle" direction="out" rot="R180"/>
<pin name="2OUT" x="17.78" y="7.62" length="middle" direction="out" rot="R180"/>
<pin name="3OUT" x="17.78" y="5.08" length="middle" direction="out" rot="R180"/>
<pin name="4OUT" x="17.78" y="2.54" length="middle" direction="out" rot="R180"/>
...
<text x="-3.7084" y="-29.6418" size="2.0828" layer="96" ratio="10" rot="SR0">&gt;VALUE</text>
</symbol>
</symbols>
<devicesets>
<deviceset name="LM324N" prefix="U">
<description>QUADRUPLE OPERATIONAL AMPLIFIERS</description>
<gates>
<gate name="A" symbol="LM324N" x="0" y="0"/>
</gates>
<devices>
...
<connect gate="A" pin="3IN+" pad="10"/>
<connect gate="A" pin="3IN-" pad="9"/>
<connect gate="A" pin="3OUT" pad="8"/>
<connect gate="A" pin="4IN+" pad="12"/>
<connect gate="A" pin="4IN-" pad="13"/>
<connect gate="A" pin="4OUT" pad="14"/>
<connect gate="A" pin="GND" pad="11"/>
<connect gate="A" pin="VCC" pad="4"/>
</connects>
<technologies>
<technology name="">
<attribute name="MPN" value="LM324N" constant="no"/>
<attribute name="OC_FARNELL" value="9755926" constant="no"/>
<attribute name="OC_NEWARK" value="60K6190" constant="no"/>
...
<parts>
<part name="R1" library="SparkFun-Resistors" deviceset="RESISTOR" device="PTH-1/2W" value="150K"/>
<part name="GND1" library="supply1" deviceset="GND" device=""/>
<part name="IC1" library="linear" deviceset="78*" device="T" technology="05"/>
<part name="R3" library="rcl" deviceset="POTENTIOMETER_" device="PT_SPIN" value="1k"/>
<part name="R2" library="resistor" deviceset="R-US_" device="0204/7" value="330"/>
<part name="LED1" library="eagle-ltspice" deviceset="LED_E" device="LD260"/>
<part name="C1" library="SparkFun-Capacitors" deviceset="10UF-25V-20%(PTH)" device="KIT" value=".1uF"/>
<part name="S1" library="SparkFun-Electromechanical" deviceset="SWITCH-SPDT" device="PTH"/>
<part name="JP2" library="SparkFun-Connectors" deviceset="M02" device="LOCK_LONGPADS" value="M02LOCK_LONGPADS"/>
<part name="JP3" library="SparkFun-Connectors" deviceset="M02" device="5MM" value="M025MM"/>
<part name="GND2" library="supply1" deviceset="GND" device=""/>
<part name="U1" library="Texas Instruments_By_element14_Batch_1" deviceset="LM324N" device=""/>
<part name="C2" library="SparkFun-Capacitors" deviceset="10UF-25V-20%(PTH)" device="KIT" value="1uF"/>
...
<instances>
<instance part="R1" gate="G$1" x="101.6" y="40.64" rot="R90"/>
<instance part="GND1" gate="1" x="96.52" y="7.62"/>
<instance part="IC1" gate="A1" x="50.8" y="53.34"/>
<instance part="R3" gate="1" x="101.6" y="20.32" rot="R270"/>
<instance part="R2" gate="G$1" x="83.82" y="40.64" rot="R90"/>
<instance part="LED1" gate="G$1" x="83.82" y="27.94"/>
<instance part="C1" gate="G$1" x="68.58" y="33.02"/>
<instance part="S1" gate="1" x="30.48" y="50.8"/>
<instance part="JP2" gate="G$1" x="7.62" y="50.8"/>
<instance part="JP3" gate="G$1" x="132.08" y="27.94" rot="R180"/>
<instance part="GND2" gate="1" x="22.86" y="38.1"/>
<instance part="U1" gate="A" x="162.56" y="33.02"/>
<instance part="C2" gate="G$1" x="111.76" y="22.86"/>
<instance part="GND3" gate="1" x="144.78" y="5.08"/>
</instances>
<busses>
</busses>
<nets>
...
<wire x1="50.8" y1="10.16" x2="50.8" y2="45.72" width="0.1524" layer="91"/>
...
<wire x1="111.76" y1="17.78" x2="111.76" y2="10.16" width="0.1524" layer="91"/>
...
<wire x1="139.7" y1="-2.54" x2="185.42" y2="-2.54" width="0.1524" layer="91"/>
<wire x1="185.42" y1="-2.54" x2="185.42" y2="43.18" width="0.1524" layer="91"/>
...
<errors>
<approved hash="104,1,144.78,43.18,U1,VCC,N$1,,,"/>
<approved hash="202,1,144.78,33.02,U1,2IN+,,,,"/>
<approved hash="202,1,144.78,30.48,U1,2IN-,,,,"/>
<approved hash="202,1,144.78,27.94,U1,3IN-,,,,"/>
<approved hash="202,1,144.78,25.4,U1,3IN+,,,,"/>
<approved hash="202,1,144.78,22.86,U1,4IN+,,,,"/>
<approved hash="202,1,144.78,20.32,U1,4IN-,,,,"/>
<approved hash="115,1,84.1417,26.67,LED1,,,,,"/>
<approved hash="115,1,31.75,49.5385,S1,,,,,"/>
</errors>
</schematic>
</drawing>
</eagle>
